...
# Operator CAMARA Quality-On-Demand endpoint.
CAMARA_QOD_BASE_URL: str = os.getenv("CAMARA_QOD_BASE_URL", "")
CAMARA_QOD_CLIENT_ID: str = os.getenv("CAMARA_QOD_CLIENT_ID", "")
CAMARA_QOD_CLIENT_SECRET: str = os.getenv("CAMARA_QOD_CLIENT_SECRET", "")

# Operator CAMARA Device Identifier endpoint.
CAMARA_DEVICE_IDENTIFIER_BASE_URL: str = os.getenv("CAMARA_DEVICE_IDENTIFIER_BASE_URL", "")
CAMARA_DEVICE_IDENTIFIER_CLIENT_ID: str = os.getenv("CAMARA_DEVICE_IDENTIFIER_CLIENT_ID", "")
CAMARA_DEVICE_IDENTIFIER_CLIENT_SECRET: str = os.getenv("CAMARA_DEVICE_IDENTIFIER_CLIENT_SECRET", "")

# Operator CAMARA Device Reachability Status Subscriptions endpoint.
CAMARA_DEVICE_REACHABILITY_SUBSCRIPTIONS_BASE_URL: str = os.getenv("CAMARA_DEVICE_REACHABILITY_SUBSCRIPTIONS_BASE_URL", "")
CAMARA_DEVICE_REACHABILITY_SUBSCRIPTIONS_CLIENT_ID: str = os.getenv("CAMARA_DEVICE_REACHABILITY_SUBSCRIPTIONS_CLIENT_ID", "")
CAMARA_DEVICE_REACHABILITY_SUBSCRIPTIONS_CLIENT_SECRET: str = os.getenv("CAMARA_DEVICE_REACHABILITY_SUBSCRIPTIONS_CLIENT_SECRET", "")

# Operator CAMARA Device Reachability Status endpoint.
CAMARA_DEVICE_REACHABILITY_STATUS_BASE_URL: str = os.getenv("CAMARA_DEVICE_REACHABILITY_STATUS_BASE_URL", "")
CAMARA_DEVICE_REACHABILITY_STATUS_CLIENT_ID: str = os.getenv("CAMARA_DEVICE_REACHABILITY_STATUS_CLIENT_ID", "")
CAMARA_DEVICE_REACHABILITY_STATUS_CLIENT_SECRET: str = os.getenv("CAMARA_DEVICE_REACHABILITY_STATUS_CLIENT_SECRET", "")
